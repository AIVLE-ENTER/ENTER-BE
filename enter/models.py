...
class Chatwindow(models.Model):
    ...
    crawling_text = models.CharField(max_length=255, blank=True, null=True)
    created_datetime = models.DateTimeField(auto_now_add=True)
    modified_datetime = models.DateTimeField(auto_now=True)
...
class Prompttemplates(models.Model):
    ...
    template_content = models.CharField(max_length=500)
    created_datetime = models.DateTimeField(auto_now_add=True)
    modified_datetime = models.DateTimeField(auto_now=True)
    is_deleted = models.IntegerField(default=0) # 삭제여부 (0: 유지, 1: 삭제)
...
class Qnaboard(models.Model):
    ...
    answer_admin = models.ForeignKey('Users', on_delete=models.CASCADE, blank=True, null=True)
...
class Questiontype(models.Model):
    ...
    question_type_title = models.CharField(unique=True, max_length=255)
    question_type_content = models.CharField(max_length=255)
